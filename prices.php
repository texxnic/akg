                   ...
                   <div class="col-md-12">
                    <div class="row">
                                ...
                                <div class="col-md-9 calcPlusMin">
                                    <div class="row">
                                        <div class="col-md-2 percentIncCounter">
                                            <div class="form-title">Филиалов</div>
                                            <div value="5" class="input-group percent_inc">
                                        ...
                                        <div class="col-md-2 percentIncCounter">
                                            <div class="form-title">Валютные счета</div>
                                            <div value="5" class="input-group percent_inc">
                                                <input type="button" value="+" class="button-plus" data-field="quantity">
                                        ...
                                        <div class="col-md-6">
                                          <div class="form-title">Ориентировочная стоимость</div>
                      ...
                      <div class="col-md-5 calculator__second">
                        <div class="row">
                          <div class="col-md-6"><div class="form-title">Валютные счета</div>
                    ...
                    <div class="col-md-6">
                        ...
                        Обстоятельства, приводящих к раздельному учету операций</div>
                        <div class="calcCheckBox">
                            <input class="percent" value="10" id="obst_sovm" type="checkbox">
                            <label for="obst_sovm">Совмещение общего режима налогообложения с ЕНВД</label>
                        </div>
                        <div class="calcCheckBox">
                            <input class="percent" value="10" id="obst_usn" type="checkbox">
                            <label for="obst_usn">Совмещение УСН с ЕНВД</label>
                        </div>
                        <div class="calcCheckBox">
                        ...
                        <div class="calcCheckBox">
                            ...
                            <label for="obst_odnovr">Одновременное осуществление операций с НДС и без НДС</label>
                        </div>
                        <div class="calcCheckBox">
                            <input class="percent" value="10" id="obst_transp" type="checkbox">
                            <label for="obst_transp">Наличие ТС на балансе организации</label>
                        </div>
                    </div>
                </div>
            </div>
