    ...
    <div id="primary" class="content-area">
        ...
        <div id="main" class="priceListMain">
            <div class="simplePageGrad">
                <div id="jumboFirstImage" class="stockBG"></div>
        ...
        <div id="jumboFirstText">
            ...
            <p id="pageJumboDesc" class="animated"  style="opacity:0;">Чистые, новые, безопасные авто и трепетная забота о вашем комфорте и безопасности - это taxТРАНС!</p>
        </div>
            <div id="pageContent">
