...
function sliderHeight() {
    ...
    if( $(".hero-section").find(".container").height() > $(window).height() ){
        ...
        $(".hero-section .owl-stage-outer").height( $(".hero-section").children(".wrapper").height() + paddingTop + "300");
        console.log("bigger");
    }
    else {
        $(".hero-section").height( $(window).height() * 0.8);
        $(".hero-section .owl-stage-outer").height( $(window).height()  * 0.8);
        console.log("smaller");
    }
